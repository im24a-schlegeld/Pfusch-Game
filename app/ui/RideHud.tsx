...
export default function RideHud({engine,best,pause}:{engine:Engine;best:number;pause:()=>void}) {
  return <div className="v42-hud" aria-label="Fahrdaten">
    ...
    <div className="v42-right-bottom"><span className="v42-combo">×{engine.combo.toFixed(1)} <small>KOMBO</small></span><button type="button" onClick={pause} aria-label="Fahrt pausieren">Ⅱ</button></div>
  </div>;
}
