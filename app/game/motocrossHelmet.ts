...
function addPeak(
  ...
  const sections: [number, number, number][] = [[-0.03,0.019,0.148],[-0.058,0.032,0.144],[-0.093,0.053,0.139],[-0.138,0.089,0.133],[-0.182,0.117,0.126],[-0.226,0.126,0.119],[-0.269,0.118,0.108],[-0.302,0.097,0.095],[-0.323,0.072,0.082]];
  const columns = [
